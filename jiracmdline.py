...
def close_issue( issue ):
    conn.transition_issue(issue, '2')
    print( "New state 'closed'" )
...
if __name__ == '__main__':
    ...
    if args.comment or args.resolve or args.take or args.give or args.close:
        do_modify()
